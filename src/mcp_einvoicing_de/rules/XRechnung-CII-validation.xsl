...
<xsl:transform xmlns:ccts="urn:un:unece:uncefact:documentation:standard:CoreComponentsTechnicalSpecification:2"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    title="Schematron Version 2.6.0 - XRechnung 3.0.2 compatible - CII">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
                               as="xs:string*"
                               select="($schxslt:patterns-matched, 'd13e394')"/>
            </xsl:next-match>
         </xsl:otherwise>
      </xsl:choose>
   </xsl:template>
         ...
         <xsl:otherwise>
          ...
          oder "SELLER TAX REPRESENTATIVE PARTY" (BG-11) übermittelt werden.
            ...
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
                               as="xs:string*"
                               select="($schxslt:patterns-matched, 'd13e419')"/>
            </xsl:next-match>
         </xsl:otherwise>
      </xsl:choose>
   </xsl:template>
   ...
   <xsl:template match="udt:DateTimeString | qdt:DateTimeString | udt:DateString"
                 priority="19"
                 mode="d13e217">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
